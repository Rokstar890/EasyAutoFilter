...
BOT_TOKEN = environ.get('BOT_TOKEN', "6325916844:AAFAP5mAQy1oR9q5UWmdaEUibegxVNE1Fy0")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001937610834').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001604462773'))
